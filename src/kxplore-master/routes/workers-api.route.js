...
var WorkersSocketRoute = /** @class */ (function () {
    function WorkersSocketRoute(config, workersHandler) {
        var _this = this;
        this.config = config;
        this.workersHandler = workersHandler;
        this.register = function (io) {
            io.of('/workers').on('connection', function (socket) {
                _this.workersHandler.connect(socket.handshake.query.uuid, socket);
                socket.on('disconnect', function () {
                    _this.workersHandler.disconnect(socket.handshake.query.uuid);
                });
            });
        };
    }
    WorkersSocketRoute = __decorate([
        di_1.Injectable(),
    ...
    return WorkersSocketRoute;
}());
exports.WorkersSocketRoute = WorkersSocketRoute;
//# sourceMappingURL=workers-api.route.js.map