...
var IConsumer_1 = require("../handlers/consumers/IConsumer");
var MasterCommunication = /** @class */ (function () {
    function MasterCommunication(config) {
        var _this = this;
        this.config = config;
        this.active = {};
        //uuid = server id~
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            */
                            socket.on("DELETE_" + jobData.job_uuid, function () { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
    ...
    MasterCommunication = __decorate([
        di_1.Injectable(),
...
exports.MasterCommunication = MasterCommunication;
//# sourceMappingURL=master-comunication.js.map